    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Enrolments", x => new { x.ModulesModuleId, x.StudentsStudentId });
                    table.ForeignKey(
                        name: "FK_Enrolments_Modules_ModulesModuleId",
                        column: x => x.ModulesModuleId,
                        principalTable: "Modules",
                        principalColumn: "ModuleId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Enrolments_Students_StudentsStudentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Enrolments_StudentsStudentId",
                table: "Enrolments",
